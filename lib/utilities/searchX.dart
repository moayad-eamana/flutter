...
/// The animation provided by [SearchDelegateR.transitionAnimation] can be used
...
/// query text field can be customized via [SearchDelegateR.buildLeading]
/// and [SearchDelegateR.buildActions]. Additionally, a widget can be placed
/// across the bottom of the [AppBar] via [SearchDelegateR.buildBottom].
///
/// The body below the [AppBar] can either show suggested queries (returned by
/// [SearchDelegateR.buildSuggestions]) or - once the user submits a search  - the
/// results of the search as returned by [SearchDelegateR.buildResults].
///
/// [SearchDelegateR.query] always contains the current query entered by the user
/// and should be used to build the suggestions and results.
///
/// The results can be brought on screen by calling [SearchDelegateR.showResults]
/// and you can go back to showing the suggestions by calling
/// [SearchDelegateR.showSuggestions].
///
...
/// ## Handling emojis and other complex characters
/// {@macro flutter.widgets.EditableText.onChanged}
abstract class SearchDelegateR<T> {
  ...
  /// {@tool snippet}
  /// ```dart
  /// class CustomSearchHintDelegate extends SearchDelegateR<String> {
...
enum _SearchBody {
  ...
  ///
  /// The suggested queries are generated by [SearchDelegateR.buildSuggestions].
  suggestions,

  /// Search results are currently shown in the body.
  ///
  /// The search results are generated by [SearchDelegateR.buildResults].
  results,
}
...
class _SearchPageRoute<T> extends PageRoute<T> {
  _SearchPageRoute({
    ...
    assert(
      ...
      'search. Please close that search by calling close() on the SearchDelegateR '
      'before opening another search with the same delegate instance.',
    );
    delegate._route = this;
  }

  final SearchDelegateR<T> delegate;

...
class WarnViolatedVehicleSftyAndSecurity extends StatefulWidget {
  @override
  State<WarnViolatedVehicleSftyAndSecurity> createState() =>
      _WarnViolatedVehicleSftyAndSecurityState();
}

class _WarnViolatedVehicleSftyAndSecurityState
    extends State<WarnViolatedVehicleSftyAndSecurity> {
  dynamic carInfo;
              ...
              if (carInfo != null)
                Column(
                  children: [
                    Row(
                      children: [
                        cards("هوية المالك", carInfo["PersonId"].toString()),
                      ],
                    ),
                    SizedBox(
                      height: 5,
                    ...
                    Row(
                      children: [
                        cards("السيارة", carInfo["MakeDescAr"]),
                        cards("نوع السيارة", carInfo["ModelDescAr"])
                      ],
                    ),
                    Row(
                      children: [
                        cards("موديل السيارة", carInfo["ModelYear"].toString()),
                        cards(
                            "الحالة",
                            carInfo["IsAlive"] == 1
                                ? "على قيد الحياة"
                    ...
                    Row(
                      children: [
                        cards("لون السيارة", carInfo["MajorColorDescAr"])
                      ],
                    ),
                    SizedBox(
                      height: 10,
